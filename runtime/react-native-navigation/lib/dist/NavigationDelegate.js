...
class NavigationDelegate {
    constructor() {
        this.concreteNavigation = this.createConcreteNavigation(new NativeCommandsSender_1.NativeCommandsSender(), new NativeEventsReceiver_1.NativeEventsReceiver());
    }
    createConcreteNavigation(nativeCommandsSender, nativeEventsReceiver) {
        return new Navigation_1.NavigationRoot(nativeCommandsSender, nativeEventsReceiver);
    }
    /**
    ...
    mockNativeComponents() {
        ...
        this.concreteNavigation = this.createConcreteNavigation(new NativeCommandsSender(), new NativeEventsReceiver());
    }
    get mock() {
        return {
